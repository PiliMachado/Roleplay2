...
{
    /// <summary>
    /// La clase Dwarf implementa ICharacter ya que estos manejan un nivel de vida, pueden ser atacados, 
    ...
    public class Dwarf : ICharacter
    {
        ...
        /// <summary>
        /// Las 2 listas de items de Dwarf son del tipo IOffensiveItem y IDefensiveItem ya que hay ciertos items que solo
        ...
        /// <summary>
        /// Los items de un Dwarf pueden ser Ofensivos y/o Defensivos, asi que al agregar items a la lista de item como parametro
        ...
        public int AttackValue
        {
            get
            {
                ...
                /// aparte de sword, no hay que cambiar la clase Dwarf sino solo agregar clases de esos nuevos items
                /// que implementen IOffensiveItem.
                /// 
                /// El attackvalue lo seteamos en 0 en un inicio porque si Dwarf no tiene items significa que no tiene daño entonces.
                /// </summary>
                int totalAttack = 0;
        ...
        public int DefenseValue
        {
            get
            {
                ...
                /// aparte de Helmet, no hay que cambiar la clase Dwarf sino solo agregar clases de esos nuevos items
                /// que implementen IDefensiveItem.
                /// 
                /// El defensevalue lo seteamos en 0 en un inicio porque si Dwarf no tiene items significa que no tiene defensa entonces.
                /// </summary>
                int totalDefense = 0;
